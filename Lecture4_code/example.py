...
def build_linkedlist(): # creat linkedlist
...
def run_linkedlist_example(): # traverse linkedlist
...
def run_linkedlist_quiz_2():
    ...
    node_1 = node_2 # cannot find the first node
...
def run_linkedlist_quiz_3(): # delete node
